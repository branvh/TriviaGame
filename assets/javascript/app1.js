...
var game = {
    ...
    answerCheck: function(selection) {
        ...
        var correctAns = game.currentItem['answer'];
        var message = '';
        var ansMsg = '';
        ...
        if (selected === ans) {
            ...
            ansMsg = 'Correct answer: ' + ans;

        }

        //quickly display question outcome
        game.displayOutcome(message, ansMsg);

    },
    displayOutcome: function(message, ans) {
        ...
        if (game.currentTime > 2) {
            ...
            $('#outcome').html(message).fadeIn();
            $('#correctAnswer').html(ans).fadeIn();

            setTimeout(function() {

                $('.questionlist').fadeIn();

                $('#outcome').fadeOut().html('');
                $('#correctAnswer').fadeOut().html('');
